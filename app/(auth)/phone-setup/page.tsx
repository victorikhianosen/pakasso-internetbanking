...
import { sendPhoneOtp, resentOtp } from "@/api/auth.service";
...
export default function PhoneSetup() {
    ...
    async function handleResendOtp(e: React.FormEvent) {
        ...
        try {
            ...
            const message = err?.message || "Unable to resend OTP. Please try again.";
            setError(message);
            toast.error(message);
        } finally {
            setLoading(false);
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center px-6">
                    <div className="w-full max-w-md">
                        ...
                        <div className="flex justify-center mb-8">
                            ...
                            <Image alt="Logo" src="/assets/images/logo.png" width={200} height={100} className="h-12 object-contain" />
